...
const AboutUs = () => {
  return (
    ...
    <div className="about-byc-africa container" >
    <div className="about-byc-africa-wrap" style={{display: 'flex', flexWrap: 'wrap', marginTop: '8%', alignItems: 'center', width: '100%', gap: '2rem', justifyContent: 'center'}}>
        <div className="about-us-img">
        <img style={{height: '350px', width: '360px'}}  src={Aboutus} alt="" />
      </div>
        <div className="about-us-content" style={{ flexDirection: 'column', alignItems: 'center', marginTop: '6%'}}>
    ...
    <div className="records container">
        <div className="records-body" >
            <div className="records-row-one" style={{display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center', marginTop: '4%', width: '100%', justifyContent: 'center'}}>
            ...
            <div className="records-row-two" style={{display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center', marginTop: '4%', justifyContent: 'center'}}>
            ...
            <div className="records-row-three" style={{display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center', marginTop: '4%', justifyContent: 'center'}}>
