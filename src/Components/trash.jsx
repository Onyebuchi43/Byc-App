            ...
            <div className="product-cards-body" style={rowStyle}>
              {sortedProducts.map((product) => (
                <div
                  key={product.id}
                  style={cardStyle}
                  onMouseEnter={(e) => (e.currentTarget.querySelector('.hover-buttons').style.display = 'flex')}
                  onMouseLeave={(e) => (e.currentTarget.querySelector('.hover-buttons').style.display = 'none')}
                >
